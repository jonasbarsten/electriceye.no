...
export default class ArtistSingle extends TrackerReact(React.Component) {
	...
	getArtist() {
		return Artists.find({_id: '8dLh25XqjSS3fTXyo'}).fetch();
	}

	getReleases() {
		return Releases.find({artists: '8dLh25XqjSS3fTXyo'}, {sort: {albumType: 1, releaseDate: -1}}).fetch();
	}
									...
									<div className="artist-single-content">
										...
										<div className="row">
											...
											<div className="subscribe-container">
												<a href="https://dm-mailinglist.com/subscribe?f=a50129ea" target="blank">
													MAILING LIST
												</a>
											</div>
